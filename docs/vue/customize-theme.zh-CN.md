...
我们在[ant-design](https://1x.ant.design/)之上拓展了一套视觉规范,旨在业务应用从繁重的视图层解放部分生产力,并且保证各业务应用有较高的视觉统一.门户卡片则是标准的实践者之一,**非常感谢您的参与也十分期待您的共建**.

## 如何使用

在您的卡片组件或其它业务组件(如有需要)中引入主题`less`变量文件
![theme.png](https://e.im5i.com/2020/11/29/theme.png)
所有的样式变量
``` less
// -------- Colors -----------
